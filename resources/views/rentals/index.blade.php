                ...
                <form method="GET" action="{{ route('cars.index') }}" class="mb-4">
                    <div class="flex">
                        <input type="text" name="search" value="{{ request('search') }}"
                            ...
                            class="py-2 px-3 block w-full border-gray-300 border rounded-l-lg text-sm focus:border-blue-500 focus:ring-blue-500">
                        <button type="submit" class="p-2 bg-blue-500 text-white rounded-r-md hover:bg-blue-600">
                            <svg class="size-4 text-gray-200" xmlns="http://www.w3.org/2000/svg" width="24"
                ...
                <table class="w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase w-40">Tanggal Sewa
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase w-40">Tanggal Kembali
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase w-40">Status
                            </th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($rentals as $index => $rental)
                            <tr class="{{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-100' }}">
                                ...
                                <td class="px-6 py-3 text-sm text-gray-700">{{ $rental->user->name ?? '-' }}</td>
