    ...
    <div class="max-w-lg mx-auto bg-white shadow-lg rounded-lg p-6 mt-10">
        ...
        <form action="{{ route('rentals.update', $rental->id) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="" value="{{ $rental->user->name }}" disabled
                    class="w-full mt-1 p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500  bg-gray-100">
